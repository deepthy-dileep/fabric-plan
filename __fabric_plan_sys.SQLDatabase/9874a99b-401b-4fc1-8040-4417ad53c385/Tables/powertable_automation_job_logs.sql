CREATE TABLE [9874a99b-401b-4fc1-8040-4417ad53c385].[powertable_automation_job_logs] (
    ...
    CONSTRAINT [FK_169466e74c029e477bef5389d61] FOREIGN KEY ([automationJobId]) REFERENCES [9874a99b-401b-4fc1-8040-4417ad53c385].[powertable_automation_jobs] ([id])
);
