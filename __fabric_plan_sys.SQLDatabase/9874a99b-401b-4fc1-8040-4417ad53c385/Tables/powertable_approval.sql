CREATE TABLE [9874a99b-401b-4fc1-8040-4417ad53c385].[powertable_approval] (
    ...
    CONSTRAINT [FK_4dc3ff09cd30268621a118617d8] FOREIGN KEY ([sourceId]) REFERENCES [9874a99b-401b-4fc1-8040-4417ad53c385].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_recordGuid]
    ON [9874a99b-401b-4fc1-8040-4417ad53c385].[powertable_approval]([recordGuid] ASC);
