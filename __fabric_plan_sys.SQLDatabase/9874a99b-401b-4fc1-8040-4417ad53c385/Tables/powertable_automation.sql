CREATE TABLE [9874a99b-401b-4fc1-8040-4417ad53c385].[powertable_automation] (
    ...
    CONSTRAINT [FK_84f71feccc1ee888ab03a46330c] FOREIGN KEY ([sourceId]) REFERENCES [9874a99b-401b-4fc1-8040-4417ad53c385].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_automation_recordGuid]
    ON [9874a99b-401b-4fc1-8040-4417ad53c385].[powertable_automation]([recordGuid] ASC);
