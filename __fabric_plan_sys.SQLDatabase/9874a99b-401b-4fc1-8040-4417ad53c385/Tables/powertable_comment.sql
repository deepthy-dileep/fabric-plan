CREATE TABLE [9874a99b-401b-4fc1-8040-4417ad53c385].[powertable_comment] (
    ...
    CONSTRAINT [FK_e923d030022f35af27a650126af] FOREIGN KEY ([sourceId]) REFERENCES [9874a99b-401b-4fc1-8040-4417ad53c385].[powertable_source] ([id])
);
