CREATE TABLE [9874a99b-401b-4fc1-8040-4417ad53c385].[ib_source] (
    ...
    CONSTRAINT [FK_857e1cee10c832cdd99e84b5e68] FOREIGN KEY ([visualId]) REFERENCES [9874a99b-401b-4fc1-8040-4417ad53c385].[visual] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_source_visualId]
    ON [9874a99b-401b-4fc1-8040-4417ad53c385].[ib_source]([visualId] ASC);


GO

CREATE NONCLUSTERED INDEX [idx_ib_source_workloadItemId]
    ON [9874a99b-401b-4fc1-8040-4417ad53c385].[ib_source]([workloadItemId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_source_recordGuid]
    ON [9874a99b-401b-4fc1-8040-4417ad53c385].[ib_source]([recordGuid] ASC);
