CREATE TABLE [9874a99b-401b-4fc1-8040-4417ad53c385].[powertable_approval_filter] (
    ...
    CONSTRAINT [FK_94539a8181a5a4dc2ea1ea42a12] FOREIGN KEY ([approvalId]) REFERENCES [9874a99b-401b-4fc1-8040-4417ad53c385].[powertable_approval] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_filter_recordGuid]
    ON [9874a99b-401b-4fc1-8040-4417ad53c385].[powertable_approval_filter]([recordGuid] ASC);
