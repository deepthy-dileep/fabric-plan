CREATE TABLE [9874a99b-401b-4fc1-8040-4417ad53c385].[powertable_approval_request_rows] (
    ...
    CONSTRAINT [FK_a782d5b8982a5f441a565c1fa12] FOREIGN KEY ([approvalRequestId]) REFERENCES [9874a99b-401b-4fc1-8040-4417ad53c385].[powertable_approval_request] ([id])
);
