CREATE TABLE [9874a99b-401b-4fc1-8040-4417ad53c385].[cube_partition_sync_logs] (
...
CREATE NONCLUSTERED INDEX [idx_cube_partition_sync_logs_partitionMeasureId]
    ON [9874a99b-401b-4fc1-8040-4417ad53c385].[cube_partition_sync_logs]([partitionMeasureId] ASC) WHERE ([status]<>(500));
