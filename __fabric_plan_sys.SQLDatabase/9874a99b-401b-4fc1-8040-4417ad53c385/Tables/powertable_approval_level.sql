CREATE TABLE [9874a99b-401b-4fc1-8040-4417ad53c385].[powertable_approval_level] (
    ...
    CONSTRAINT [FK_c83f41d1a622e4368ad562c3310] FOREIGN KEY ([approvalId]) REFERENCES [9874a99b-401b-4fc1-8040-4417ad53c385].[powertable_approval] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_level_recordGuid]
    ON [9874a99b-401b-4fc1-8040-4417ad53c385].[powertable_approval_level]([recordGuid] ASC);
