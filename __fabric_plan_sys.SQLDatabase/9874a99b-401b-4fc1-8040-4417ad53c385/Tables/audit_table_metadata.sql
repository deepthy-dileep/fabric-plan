CREATE TABLE [9874a99b-401b-4fc1-8040-4417ad53c385].[audit_table_metadata] (
    ...
    CONSTRAINT [FK_92e65ca174f48ee8c2d2276faf1] FOREIGN KEY ([visualId]) REFERENCES [9874a99b-401b-4fc1-8040-4417ad53c385].[visual] ([id])
);
...
CREATE NONCLUSTERED INDEX [idx_audit_table_metadata_visualId_dimensionHash]
    ON [9874a99b-401b-4fc1-8040-4417ad53c385].[audit_table_metadata]([visualId] ASC, [dimensionHash] ASC);
