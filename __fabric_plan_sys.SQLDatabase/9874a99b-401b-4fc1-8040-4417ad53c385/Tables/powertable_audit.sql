CREATE TABLE [9874a99b-401b-4fc1-8040-4417ad53c385].[powertable_audit] (
...
CREATE NONCLUSTERED INDEX [idx_status_activityType_entityId_entityType_action]
    ON [9874a99b-401b-4fc1-8040-4417ad53c385].[powertable_audit]([status] ASC, [activityType] ASC, [entityId] ASC, [entityType] ASC, [action] ASC);
