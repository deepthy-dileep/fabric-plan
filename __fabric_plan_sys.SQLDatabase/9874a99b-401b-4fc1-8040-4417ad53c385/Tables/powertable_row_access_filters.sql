CREATE TABLE [9874a99b-401b-4fc1-8040-4417ad53c385].[powertable_row_access_filters] (
    ...
    CONSTRAINT [FK_4cf5fc924af7310bf47527e6997] FOREIGN KEY ([sourceSettingsId]) REFERENCES [9874a99b-401b-4fc1-8040-4417ad53c385].[powertable_source_settings] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_row_access_filters_recordGuid]
    ON [9874a99b-401b-4fc1-8040-4417ad53c385].[powertable_row_access_filters]([recordGuid] ASC);
