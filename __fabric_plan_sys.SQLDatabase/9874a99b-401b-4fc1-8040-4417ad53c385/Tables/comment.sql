CREATE TABLE [9874a99b-401b-4fc1-8040-4417ad53c385].[comment] (
    ...
    CONSTRAINT [FK_c17116b9b990ba6990fd8b139b7] FOREIGN KEY ([visualId]) REFERENCES [9874a99b-401b-4fc1-8040-4417ad53c385].[visual] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [IX_comment_parentRecordGuid]
    ON [9874a99b-401b-4fc1-8040-4417ad53c385].[comment]([parentRecordGuid] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_comment_recordGuid]
    ON [9874a99b-401b-4fc1-8040-4417ad53c385].[comment]([recordGuid] ASC);
