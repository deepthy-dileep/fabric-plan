CREATE TABLE [9874a99b-401b-4fc1-8040-4417ad53c385].[writeback_settings] (
    ...
    CONSTRAINT [FK_94e8f3168953c07cd61ff067f34] FOREIGN KEY ([visualId]) REFERENCES [9874a99b-401b-4fc1-8040-4417ad53c385].[visual] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_writeback_settings_recordGuid]
    ON [9874a99b-401b-4fc1-8040-4417ad53c385].[writeback_settings]([recordGuid] ASC);
