CREATE TABLE [9874a99b-401b-4fc1-8040-4417ad53c385].[powertable_forms] (
    ...
    CONSTRAINT [FK_64f3daea4f2056ece36b93069fa] FOREIGN KEY ([sourceId]) REFERENCES [9874a99b-401b-4fc1-8040-4417ad53c385].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_forms_recordGuid]
    ON [9874a99b-401b-4fc1-8040-4417ad53c385].[powertable_forms]([recordGuid] ASC);
