CREATE TABLE [9874a99b-401b-4fc1-8040-4417ad53c385].[ib_query_writeback_destination] (
    ...
    CONSTRAINT [FK_7534fdf394126d74de811d59cd7] FOREIGN KEY ([queryId]) REFERENCES [9874a99b-401b-4fc1-8040-4417ad53c385].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_writeback_destination_queryId]
    ON [9874a99b-401b-4fc1-8040-4417ad53c385].[ib_query_writeback_destination]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_writeback_destination_recordGuid]
    ON [9874a99b-401b-4fc1-8040-4417ad53c385].[ib_query_writeback_destination]([recordGuid] ASC);
