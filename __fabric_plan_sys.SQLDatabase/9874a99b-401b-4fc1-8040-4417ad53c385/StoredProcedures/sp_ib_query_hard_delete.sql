      ...
      CREATE   PROCEDURE [9874a99b-401b-4fc1-8040-4417ad53c385].[sp_ib_query_hard_delete] 
      ...
      BEGIN
        ...
        BEGIN TRY
          ...
          SET @sql = @sql + N'
            DELETE qj
            FROM [9874a99b-401b-4fc1-8040-4417ad53c385].[ib_query_jobs] qj
          ...
          SET @sql = @sql + N'
            DELETE qw
            FROM [9874a99b-401b-4fc1-8040-4417ad53c385].[ib_query_writeback] qw
