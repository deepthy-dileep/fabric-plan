                          ...
                          CREATE PROCEDURE [9874a99b-401b-4fc1-8040-4417ad53c385].[sp_powertable_approval_request_rows_batch_update] 
                      ...
                      BEGIN
                          ...
                          -- Update the values
                          SET @sql = @sql + 'UPDATE [9874a99b-401b-4fc1-8040-4417ad53c385].powertable_approval_request_rows 
                          SET 
                              ' + @updateColumn + ' = ' + @updateValue + ',
                              updatedBy = @updatedBy,
                              updatedAt = @updatedAt
                          FROM [9874a99b-401b-4fc1-8040-4417ad53c385].powertable_approval_request_rows
