                ...
                CREATE PROCEDURE [9874a99b-401b-4fc1-8040-4417ad53c385].[sp_powertable_approval_request_rows_batch_insert] 
...
BEGIN
    ...
    SET @sql = @sql + N'
        INSERT INTO [9874a99b-401b-4fc1-8040-4417ad53c385].powertable_approval_request_rows
            (rowId, rowMeta, approvalRequestId, createdBy, updatedBy, createdAt, updatedAt)
        SELECT
