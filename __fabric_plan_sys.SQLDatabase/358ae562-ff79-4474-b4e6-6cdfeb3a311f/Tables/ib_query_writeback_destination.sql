CREATE TABLE [358ae562-ff79-4474-b4e6-6cdfeb3a311f].[ib_query_writeback_destination] (
    ...
    CONSTRAINT [FK_7534fdf394126d74de811d59cd7] FOREIGN KEY ([queryId]) REFERENCES [358ae562-ff79-4474-b4e6-6cdfeb3a311f].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_writeback_destination_queryId]
    ON [358ae562-ff79-4474-b4e6-6cdfeb3a311f].[ib_query_writeback_destination]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_writeback_destination_recordGuid]
    ON [358ae562-ff79-4474-b4e6-6cdfeb3a311f].[ib_query_writeback_destination]([recordGuid] ASC);
