CREATE TABLE [358ae562-ff79-4474-b4e6-6cdfeb3a311f].[cube_partition_sync_logs] (
...
CREATE NONCLUSTERED INDEX [idx_cube_partition_sync_logs_partitionMeasureId]
    ON [358ae562-ff79-4474-b4e6-6cdfeb3a311f].[cube_partition_sync_logs]([partitionMeasureId] ASC) WHERE ([status]<>(500));
