CREATE TABLE [358ae562-ff79-4474-b4e6-6cdfeb3a311f].[ib_query_writeback_settings] (
    ...
    CONSTRAINT [FK_8bcb8471b229716279935805b96] FOREIGN KEY ([queryId]) REFERENCES [358ae562-ff79-4474-b4e6-6cdfeb3a311f].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_writeback_settings_queryId]
    ON [358ae562-ff79-4474-b4e6-6cdfeb3a311f].[ib_query_writeback_settings]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_writeback_settings_recordGuid]
    ON [358ae562-ff79-4474-b4e6-6cdfeb3a311f].[ib_query_writeback_settings]([recordGuid] ASC);
