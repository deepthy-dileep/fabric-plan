CREATE TABLE [358ae562-ff79-4474-b4e6-6cdfeb3a311f].[powertable_approval_request_rows] (
    ...
    CONSTRAINT [FK_a782d5b8982a5f441a565c1fa12] FOREIGN KEY ([approvalRequestId]) REFERENCES [358ae562-ff79-4474-b4e6-6cdfeb3a311f].[powertable_approval_request] ([id])
);
