CREATE TABLE [358ae562-ff79-4474-b4e6-6cdfeb3a311f].[powertable_audit] (
...
CREATE NONCLUSTERED INDEX [idx_status_activityType_entityId_entityType_action]
    ON [358ae562-ff79-4474-b4e6-6cdfeb3a311f].[powertable_audit]([status] ASC, [activityType] ASC, [entityId] ASC, [entityType] ASC, [action] ASC);
