CREATE TABLE [358ae562-ff79-4474-b4e6-6cdfeb3a311f].[ib_query_transformation_steps] (
    ...
    CONSTRAINT [FK_8a9b406684b6d9fc5b0e6a20189] FOREIGN KEY ([queryId]) REFERENCES [358ae562-ff79-4474-b4e6-6cdfeb3a311f].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_transformation_steps_queryId]
    ON [358ae562-ff79-4474-b4e6-6cdfeb3a311f].[ib_query_transformation_steps]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_transformation_steps_recordGuid]
    ON [358ae562-ff79-4474-b4e6-6cdfeb3a311f].[ib_query_transformation_steps]([recordGuid] ASC);
