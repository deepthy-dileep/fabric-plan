CREATE TABLE [358ae562-ff79-4474-b4e6-6cdfeb3a311f].[comment] (
    ...
    CONSTRAINT [FK_c17116b9b990ba6990fd8b139b7] FOREIGN KEY ([visualId]) REFERENCES [358ae562-ff79-4474-b4e6-6cdfeb3a311f].[visual] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [IX_comment_parentRecordGuid]
    ON [358ae562-ff79-4474-b4e6-6cdfeb3a311f].[comment]([parentRecordGuid] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_comment_recordGuid]
    ON [358ae562-ff79-4474-b4e6-6cdfeb3a311f].[comment]([recordGuid] ASC);
