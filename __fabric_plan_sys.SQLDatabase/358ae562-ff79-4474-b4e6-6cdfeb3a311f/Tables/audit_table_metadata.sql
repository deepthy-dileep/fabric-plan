CREATE TABLE [358ae562-ff79-4474-b4e6-6cdfeb3a311f].[audit_table_metadata] (
    ...
    CONSTRAINT [FK_92e65ca174f48ee8c2d2276faf1] FOREIGN KEY ([visualId]) REFERENCES [358ae562-ff79-4474-b4e6-6cdfeb3a311f].[visual] ([id])
);
...
CREATE NONCLUSTERED INDEX [idx_audit_table_metadata_visualId_dimensionHash]
    ON [358ae562-ff79-4474-b4e6-6cdfeb3a311f].[audit_table_metadata]([visualId] ASC, [dimensionHash] ASC);
