CREATE TABLE [358ae562-ff79-4474-b4e6-6cdfeb3a311f].[powertable_approval_level] (
    ...
    CONSTRAINT [FK_c83f41d1a622e4368ad562c3310] FOREIGN KEY ([approvalId]) REFERENCES [358ae562-ff79-4474-b4e6-6cdfeb3a311f].[powertable_approval] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_level_recordGuid]
    ON [358ae562-ff79-4474-b4e6-6cdfeb3a311f].[powertable_approval_level]([recordGuid] ASC);
