            ...
            CREATE PROCEDURE [358ae562-ff79-4474-b4e6-6cdfeb3a311f].[sp_planning_di_row_batch_update] 
            ...
            DECLARE @TempTableName NVARCHAR(128) = '#CR_UPDATE_TEMP' + REPLACE(REPLACE(REPLACE(REPLACE(@currentTimeString, '-', ''), ':', ''),' ',''),'.','');
              ...
              -- Insert data into the temporary table using dynamic SQL
                ...
                SET @sql = @sql + 'UPDATE [358ae562-ff79-4474-b4e6-6cdfeb3a311f].data_input_row 
                SET 
                    ...
                    updatedBy = @updatedBy,
                    updatedAt = @updatedAt
                FROM [358ae562-ff79-4474-b4e6-6cdfeb3a311f].data_input_row
                INNER JOIN [358ae562-ff79-4474-b4e6-6cdfeb3a311f].' +  @TempTableName + ' as temp on temp.id = data_input_row.id;';
