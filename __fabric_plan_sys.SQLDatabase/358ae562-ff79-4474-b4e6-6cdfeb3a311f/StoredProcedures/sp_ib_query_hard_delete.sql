      ...
      CREATE   PROCEDURE [358ae562-ff79-4474-b4e6-6cdfeb3a311f].[sp_ib_query_hard_delete] 
      ...
      BEGIN
        ...
        BEGIN TRY
          ...
          SET @sql = @sql + N'
            DELETE qj
            FROM [358ae562-ff79-4474-b4e6-6cdfeb3a311f].[ib_query_jobs] qj
          ...
          SET @sql = @sql + N'
            DELETE qw
            FROM [358ae562-ff79-4474-b4e6-6cdfeb3a311f].[ib_query_writeback] qw
