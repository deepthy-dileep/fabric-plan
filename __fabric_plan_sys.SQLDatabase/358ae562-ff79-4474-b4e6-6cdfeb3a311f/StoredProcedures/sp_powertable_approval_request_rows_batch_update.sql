                          ...
                          CREATE PROCEDURE [358ae562-ff79-4474-b4e6-6cdfeb3a311f].[sp_powertable_approval_request_rows_batch_update] 
                      ...
                      BEGIN
                          ...
                          -- Update the values
                          SET @sql = @sql + 'UPDATE [358ae562-ff79-4474-b4e6-6cdfeb3a311f].powertable_approval_request_rows 
                          SET 
                              ' + @updateColumn + ' = ' + @updateValue + ',
                              updatedBy = @updatedBy,
                              updatedAt = @updatedAt
                          FROM [358ae562-ff79-4474-b4e6-6cdfeb3a311f].powertable_approval_request_rows
