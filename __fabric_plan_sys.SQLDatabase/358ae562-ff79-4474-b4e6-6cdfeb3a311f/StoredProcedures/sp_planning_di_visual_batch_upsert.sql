        ...
        CREATE   PROCEDURE [358ae562-ff79-4474-b4e6-6cdfeb3a311f].[sp_planning_di_visual_batch_upsert]
        ...
        BEGIN
          ...
          SELECT @UpdateSetClause = STRING_AGG(
            CASE 
              WHEN JSON_VALUE(value, '$.isMetaColumn') = 'true' THEN
                QUOTENAME(JSON_VALUE(value, '$.name')) + ' = [358ae562-ff79-4474-b4e6-6cdfeb3a311f].[MergeDIMeasureMeta](div.' + QUOTENAME(JSON_VALUE(value, '$.name')) + ', stg.' + QUOTENAME(JSON_VALUE(value, '$.name')) + ', @UpdatedAt, @UpdatedBy, @UpdatedByUPN)'
              ELSE
          ...
          DECLARE @sql NVARCHAR(MAX) = N'
            ...
            MERGE INTO [358ae562-ff79-4474-b4e6-6cdfeb3a311f].' + QUOTENAME(@DIVTableName) + ' AS div
            ...
            BEGIN
              SELECT div.*
              FROM [358ae562-ff79-4474-b4e6-6cdfeb3a311f].' + QUOTENAME(@DIVTableName) + ' AS div
