              ...
              CREATE PROCEDURE [358ae562-ff79-4474-b4e6-6cdfeb3a311f].[sp_powertable_approval_request_rows_batch_delete] 
          ...
          BEGIN
              ...
              SET @sql = @sql + 'UPDATE [358ae562-ff79-4474-b4e6-6cdfeb3a311f].powertable_approval_request_rows SET status = 500 FROM [358ae562-ff79-4474-b4e6-6cdfeb3a311f].powertable_approval_request_rows inner join ' + @TempTableName + ' as temp on temp.rowMeta = powertable_approval_request_rows.rowMeta where powertable_approval_request_rows.approvalRequestId = @approvalRequestId;';
