                ...
                CREATE PROCEDURE [358ae562-ff79-4474-b4e6-6cdfeb3a311f].[sp_powertable_approval_request_rows_batch_insert] 
...
BEGIN
    ...
    SET @sql = @sql + N'
        INSERT INTO [358ae562-ff79-4474-b4e6-6cdfeb3a311f].powertable_approval_request_rows
            (rowId, rowMeta, approvalRequestId, createdBy, updatedBy, createdAt, updatedAt)
        SELECT
