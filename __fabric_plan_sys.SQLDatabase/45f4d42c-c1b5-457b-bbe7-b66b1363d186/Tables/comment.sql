CREATE TABLE [45f4d42c-c1b5-457b-bbe7-b66b1363d186].[comment] (
    ...
    CONSTRAINT [FK_c17116b9b990ba6990fd8b139b7] FOREIGN KEY ([visualId]) REFERENCES [45f4d42c-c1b5-457b-bbe7-b66b1363d186].[visual] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [IX_comment_parentRecordGuid]
    ON [45f4d42c-c1b5-457b-bbe7-b66b1363d186].[comment]([parentRecordGuid] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_comment_recordGuid]
    ON [45f4d42c-c1b5-457b-bbe7-b66b1363d186].[comment]([recordGuid] ASC);
