CREATE TABLE [45f4d42c-c1b5-457b-bbe7-b66b1363d186].[powertable_audit] (
...
CREATE NONCLUSTERED INDEX [idx_status_activityType_entityId_entityType_action]
    ON [45f4d42c-c1b5-457b-bbe7-b66b1363d186].[powertable_audit]([status] ASC, [activityType] ASC, [entityId] ASC, [entityType] ASC, [action] ASC);
