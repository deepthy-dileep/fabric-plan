CREATE TABLE [45f4d42c-c1b5-457b-bbe7-b66b1363d186].[powertable_approval_level] (
    ...
    CONSTRAINT [FK_c83f41d1a622e4368ad562c3310] FOREIGN KEY ([approvalId]) REFERENCES [45f4d42c-c1b5-457b-bbe7-b66b1363d186].[powertable_approval] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_level_recordGuid]
    ON [45f4d42c-c1b5-457b-bbe7-b66b1363d186].[powertable_approval_level]([recordGuid] ASC);
