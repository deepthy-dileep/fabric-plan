CREATE TABLE [45f4d42c-c1b5-457b-bbe7-b66b1363d186].[ib_source] (
    ...
    CONSTRAINT [FK_857e1cee10c832cdd99e84b5e68] FOREIGN KEY ([visualId]) REFERENCES [45f4d42c-c1b5-457b-bbe7-b66b1363d186].[visual] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_source_visualId]
    ON [45f4d42c-c1b5-457b-bbe7-b66b1363d186].[ib_source]([visualId] ASC);


GO

CREATE NONCLUSTERED INDEX [idx_ib_source_workloadItemId]
    ON [45f4d42c-c1b5-457b-bbe7-b66b1363d186].[ib_source]([workloadItemId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_source_recordGuid]
    ON [45f4d42c-c1b5-457b-bbe7-b66b1363d186].[ib_source]([recordGuid] ASC);
