CREATE TABLE [45f4d42c-c1b5-457b-bbe7-b66b1363d186].[writeback_settings] (
    ...
    CONSTRAINT [FK_94e8f3168953c07cd61ff067f34] FOREIGN KEY ([visualId]) REFERENCES [45f4d42c-c1b5-457b-bbe7-b66b1363d186].[visual] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_writeback_settings_recordGuid]
    ON [45f4d42c-c1b5-457b-bbe7-b66b1363d186].[writeback_settings]([recordGuid] ASC);
