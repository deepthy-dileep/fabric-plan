CREATE TABLE [45f4d42c-c1b5-457b-bbe7-b66b1363d186].[powertable_approval_request_logs] (
    ...
    CONSTRAINT [FK_f93b73db3abf98a99f7f3ed6092] FOREIGN KEY ([approvalRequestId]) REFERENCES [45f4d42c-c1b5-457b-bbe7-b66b1363d186].[powertable_approval_request] ([id])
);
