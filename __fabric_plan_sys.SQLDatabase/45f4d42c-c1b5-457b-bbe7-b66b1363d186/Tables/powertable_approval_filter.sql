CREATE TABLE [45f4d42c-c1b5-457b-bbe7-b66b1363d186].[powertable_approval_filter] (
    ...
    CONSTRAINT [FK_94539a8181a5a4dc2ea1ea42a12] FOREIGN KEY ([approvalId]) REFERENCES [45f4d42c-c1b5-457b-bbe7-b66b1363d186].[powertable_approval] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_filter_recordGuid]
    ON [45f4d42c-c1b5-457b-bbe7-b66b1363d186].[powertable_approval_filter]([recordGuid] ASC);
