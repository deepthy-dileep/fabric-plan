CREATE TABLE [45f4d42c-c1b5-457b-bbe7-b66b1363d186].[ib_query_writeback_destination] (
    ...
    CONSTRAINT [FK_7534fdf394126d74de811d59cd7] FOREIGN KEY ([queryId]) REFERENCES [45f4d42c-c1b5-457b-bbe7-b66b1363d186].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_writeback_destination_queryId]
    ON [45f4d42c-c1b5-457b-bbe7-b66b1363d186].[ib_query_writeback_destination]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_writeback_destination_recordGuid]
    ON [45f4d42c-c1b5-457b-bbe7-b66b1363d186].[ib_query_writeback_destination]([recordGuid] ASC);
