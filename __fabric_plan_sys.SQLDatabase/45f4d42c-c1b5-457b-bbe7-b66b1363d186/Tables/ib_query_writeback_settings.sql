CREATE TABLE [45f4d42c-c1b5-457b-bbe7-b66b1363d186].[ib_query_writeback_settings] (
    ...
    CONSTRAINT [FK_8bcb8471b229716279935805b96] FOREIGN KEY ([queryId]) REFERENCES [45f4d42c-c1b5-457b-bbe7-b66b1363d186].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_writeback_settings_queryId]
    ON [45f4d42c-c1b5-457b-bbe7-b66b1363d186].[ib_query_writeback_settings]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_writeback_settings_recordGuid]
    ON [45f4d42c-c1b5-457b-bbe7-b66b1363d186].[ib_query_writeback_settings]([recordGuid] ASC);
