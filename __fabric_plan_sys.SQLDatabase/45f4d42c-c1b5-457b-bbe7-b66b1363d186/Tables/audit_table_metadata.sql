CREATE TABLE [45f4d42c-c1b5-457b-bbe7-b66b1363d186].[audit_table_metadata] (
    ...
    CONSTRAINT [FK_92e65ca174f48ee8c2d2276faf1] FOREIGN KEY ([visualId]) REFERENCES [45f4d42c-c1b5-457b-bbe7-b66b1363d186].[visual] ([id])
);
...
CREATE NONCLUSTERED INDEX [idx_audit_table_metadata_visualId_dimensionHash]
    ON [45f4d42c-c1b5-457b-bbe7-b66b1363d186].[audit_table_metadata]([visualId] ASC, [dimensionHash] ASC);
