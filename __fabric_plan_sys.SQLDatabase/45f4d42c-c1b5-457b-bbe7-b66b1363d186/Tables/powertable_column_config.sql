CREATE TABLE [45f4d42c-c1b5-457b-bbe7-b66b1363d186].[powertable_column_config] (
    ...
    CONSTRAINT [FK_861df9ce80f8cd19e53d376dbcb] FOREIGN KEY ([sourceId]) REFERENCES [45f4d42c-c1b5-457b-bbe7-b66b1363d186].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_column_config_recordGuid]
    ON [45f4d42c-c1b5-457b-bbe7-b66b1363d186].[powertable_column_config]([recordGuid] ASC);
