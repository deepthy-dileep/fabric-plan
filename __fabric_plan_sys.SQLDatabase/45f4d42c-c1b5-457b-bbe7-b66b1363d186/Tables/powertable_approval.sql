CREATE TABLE [45f4d42c-c1b5-457b-bbe7-b66b1363d186].[powertable_approval] (
    ...
    CONSTRAINT [FK_4dc3ff09cd30268621a118617d8] FOREIGN KEY ([sourceId]) REFERENCES [45f4d42c-c1b5-457b-bbe7-b66b1363d186].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_recordGuid]
    ON [45f4d42c-c1b5-457b-bbe7-b66b1363d186].[powertable_approval]([recordGuid] ASC);
