                          ...
                          CREATE PROCEDURE [45f4d42c-c1b5-457b-bbe7-b66b1363d186].[sp_powertable_approval_request_rows_batch_update] 
                      ...
                      BEGIN
                          ...
                          -- Update the values
                          SET @sql = @sql + 'UPDATE [45f4d42c-c1b5-457b-bbe7-b66b1363d186].powertable_approval_request_rows 
                          SET 
                              ' + @updateColumn + ' = ' + @updateValue + ',
                              updatedBy = @updatedBy,
                              updatedAt = @updatedAt
                          FROM [45f4d42c-c1b5-457b-bbe7-b66b1363d186].powertable_approval_request_rows
