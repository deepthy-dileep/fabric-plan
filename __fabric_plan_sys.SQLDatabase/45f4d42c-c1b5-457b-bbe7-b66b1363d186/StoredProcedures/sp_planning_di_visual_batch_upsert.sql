        ...
        CREATE   PROCEDURE [45f4d42c-c1b5-457b-bbe7-b66b1363d186].[sp_planning_di_visual_batch_upsert]
        ...
        BEGIN
          ...
          SELECT @UpdateSetClause = STRING_AGG(
            CASE 
              WHEN JSON_VALUE(value, '$.isMetaColumn') = 'true' THEN
                QUOTENAME(JSON_VALUE(value, '$.name')) + ' = [45f4d42c-c1b5-457b-bbe7-b66b1363d186].[MergeDIMeasureMeta](div.' + QUOTENAME(JSON_VALUE(value, '$.name')) + ', stg.' + QUOTENAME(JSON_VALUE(value, '$.name')) + ', @UpdatedAt, @UpdatedBy, @UpdatedByUPN)'
              ELSE
          ...
          DECLARE @sql NVARCHAR(MAX) = N'
            ...
            MERGE INTO [45f4d42c-c1b5-457b-bbe7-b66b1363d186].' + QUOTENAME(@DIVTableName) + ' AS div
            ...
            BEGIN
              SELECT div.*
              FROM [45f4d42c-c1b5-457b-bbe7-b66b1363d186].' + QUOTENAME(@DIVTableName) + ' AS div
