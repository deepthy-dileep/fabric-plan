            ...
            CREATE PROCEDURE [45f4d42c-c1b5-457b-bbe7-b66b1363d186].[sp_planning_di_row_batch_update] 
            ...
            DECLARE @TempTableName NVARCHAR(128) = '#CR_UPDATE_TEMP' + REPLACE(REPLACE(REPLACE(REPLACE(@currentTimeString, '-', ''), ':', ''),' ',''),'.','');
              ...
              -- Insert data into the temporary table using dynamic SQL
                ...
                SET @sql = @sql + 'UPDATE [45f4d42c-c1b5-457b-bbe7-b66b1363d186].data_input_row 
                SET 
                    ...
                    updatedBy = @updatedBy,
                    updatedAt = @updatedAt
                FROM [45f4d42c-c1b5-457b-bbe7-b66b1363d186].data_input_row
                INNER JOIN [45f4d42c-c1b5-457b-bbe7-b66b1363d186].' +  @TempTableName + ' as temp on temp.id = data_input_row.id;';
