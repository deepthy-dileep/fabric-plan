              ...
              CREATE PROCEDURE [45f4d42c-c1b5-457b-bbe7-b66b1363d186].[sp_powertable_approval_request_rows_batch_delete] 
          ...
          BEGIN
              ...
              SET @sql = @sql + 'UPDATE [45f4d42c-c1b5-457b-bbe7-b66b1363d186].powertable_approval_request_rows SET status = 500 FROM [45f4d42c-c1b5-457b-bbe7-b66b1363d186].powertable_approval_request_rows inner join ' + @TempTableName + ' as temp on temp.rowMeta = powertable_approval_request_rows.rowMeta where powertable_approval_request_rows.approvalRequestId = @approvalRequestId;';
