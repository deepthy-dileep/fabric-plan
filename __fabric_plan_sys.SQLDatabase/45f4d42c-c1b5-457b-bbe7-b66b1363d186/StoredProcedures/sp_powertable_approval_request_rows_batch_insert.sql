                ...
                CREATE PROCEDURE [45f4d42c-c1b5-457b-bbe7-b66b1363d186].[sp_powertable_approval_request_rows_batch_insert] 
...
BEGIN
    ...
    SET @sql = @sql + N'
        INSERT INTO [45f4d42c-c1b5-457b-bbe7-b66b1363d186].powertable_approval_request_rows
            (rowId, rowMeta, approvalRequestId, createdBy, updatedBy, createdAt, updatedAt)
        SELECT
