              ...
              CREATE PROCEDURE [808780e9-fb56-4068-b298-b142ebf3aea8].[sp_powertable_approval_request_rows_batch_delete] 
          ...
          BEGIN
              ...
              SET @sql = @sql + 'UPDATE [808780e9-fb56-4068-b298-b142ebf3aea8].powertable_approval_request_rows SET status = 500 FROM [808780e9-fb56-4068-b298-b142ebf3aea8].powertable_approval_request_rows inner join ' + @TempTableName + ' as temp on temp.rowMeta = powertable_approval_request_rows.rowMeta where powertable_approval_request_rows.approvalRequestId = @approvalRequestId;';
