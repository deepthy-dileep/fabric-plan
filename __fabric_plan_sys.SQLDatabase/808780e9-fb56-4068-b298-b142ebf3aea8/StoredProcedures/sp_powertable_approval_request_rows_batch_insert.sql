                ...
                CREATE PROCEDURE [808780e9-fb56-4068-b298-b142ebf3aea8].[sp_powertable_approval_request_rows_batch_insert] 
...
BEGIN
    ...
    SET @sql = @sql + N'
        INSERT INTO [808780e9-fb56-4068-b298-b142ebf3aea8].powertable_approval_request_rows
            (rowId, rowMeta, approvalRequestId, createdBy, updatedBy, createdAt, updatedAt)
        SELECT
