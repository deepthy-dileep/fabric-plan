      ...
      CREATE   PROCEDURE [808780e9-fb56-4068-b298-b142ebf3aea8].[sp_ib_query_hard_delete] 
      ...
      BEGIN
        ...
        BEGIN TRY
          ...
          SET @sql = @sql + N'
            DELETE qj
            FROM [808780e9-fb56-4068-b298-b142ebf3aea8].[ib_query_jobs] qj
          ...
          SET @sql = @sql + N'
            DELETE qw
            FROM [808780e9-fb56-4068-b298-b142ebf3aea8].[ib_query_writeback] qw
