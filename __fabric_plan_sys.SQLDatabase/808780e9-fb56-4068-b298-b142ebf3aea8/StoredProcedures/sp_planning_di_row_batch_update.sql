            ...
            CREATE PROCEDURE [808780e9-fb56-4068-b298-b142ebf3aea8].[sp_planning_di_row_batch_update] 
            ...
            DECLARE @TempTableName NVARCHAR(128) = '#CR_UPDATE_TEMP' + REPLACE(REPLACE(REPLACE(REPLACE(@currentTimeString, '-', ''), ':', ''),' ',''),'.','');
              ...
              -- Insert data into the temporary table using dynamic SQL
                ...
                SET @sql = @sql + 'UPDATE [808780e9-fb56-4068-b298-b142ebf3aea8].data_input_row 
                SET 
                    ...
                    updatedBy = @updatedBy,
                    updatedAt = @updatedAt
                FROM [808780e9-fb56-4068-b298-b142ebf3aea8].data_input_row
                INNER JOIN [808780e9-fb56-4068-b298-b142ebf3aea8].' +  @TempTableName + ' as temp on temp.id = data_input_row.id;';
