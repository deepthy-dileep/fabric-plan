                          ...
                          CREATE PROCEDURE [808780e9-fb56-4068-b298-b142ebf3aea8].[sp_powertable_approval_request_rows_batch_update] 
                      ...
                      BEGIN
                          ...
                          -- Update the values
                          SET @sql = @sql + 'UPDATE [808780e9-fb56-4068-b298-b142ebf3aea8].powertable_approval_request_rows 
                          SET 
                              ' + @updateColumn + ' = ' + @updateValue + ',
                              updatedBy = @updatedBy,
                              updatedAt = @updatedAt
                          FROM [808780e9-fb56-4068-b298-b142ebf3aea8].powertable_approval_request_rows
