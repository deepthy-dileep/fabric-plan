CREATE TABLE [808780e9-fb56-4068-b298-b142ebf3aea8].[powertable_audit] (
...
CREATE NONCLUSTERED INDEX [idx_status_activityType_entityId_entityType_action]
    ON [808780e9-fb56-4068-b298-b142ebf3aea8].[powertable_audit]([status] ASC, [activityType] ASC, [entityId] ASC, [entityType] ASC, [action] ASC);
