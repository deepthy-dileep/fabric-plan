CREATE TABLE [808780e9-fb56-4068-b298-b142ebf3aea8].[powertable_approval_request_rows] (
    ...
    CONSTRAINT [FK_a782d5b8982a5f441a565c1fa12] FOREIGN KEY ([approvalRequestId]) REFERENCES [808780e9-fb56-4068-b298-b142ebf3aea8].[powertable_approval_request] ([id])
);
