CREATE TABLE [808780e9-fb56-4068-b298-b142ebf3aea8].[powertable_comment] (
    ...
    CONSTRAINT [FK_e923d030022f35af27a650126af] FOREIGN KEY ([sourceId]) REFERENCES [808780e9-fb56-4068-b298-b142ebf3aea8].[powertable_source] ([id])
);
