CREATE TABLE [808780e9-fb56-4068-b298-b142ebf3aea8].[powertable_column_config] (
    ...
    CONSTRAINT [FK_861df9ce80f8cd19e53d376dbcb] FOREIGN KEY ([sourceId]) REFERENCES [808780e9-fb56-4068-b298-b142ebf3aea8].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_column_config_recordGuid]
    ON [808780e9-fb56-4068-b298-b142ebf3aea8].[powertable_column_config]([recordGuid] ASC);
