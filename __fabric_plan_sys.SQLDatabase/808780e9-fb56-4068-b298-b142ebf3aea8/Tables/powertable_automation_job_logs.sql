CREATE TABLE [808780e9-fb56-4068-b298-b142ebf3aea8].[powertable_automation_job_logs] (
    ...
    CONSTRAINT [FK_169466e74c029e477bef5389d61] FOREIGN KEY ([automationJobId]) REFERENCES [808780e9-fb56-4068-b298-b142ebf3aea8].[powertable_automation_jobs] ([id])
);
