CREATE TABLE [808780e9-fb56-4068-b298-b142ebf3aea8].[comment] (
    ...
    CONSTRAINT [FK_c17116b9b990ba6990fd8b139b7] FOREIGN KEY ([visualId]) REFERENCES [808780e9-fb56-4068-b298-b142ebf3aea8].[visual] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [IX_comment_parentRecordGuid]
    ON [808780e9-fb56-4068-b298-b142ebf3aea8].[comment]([parentRecordGuid] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_comment_recordGuid]
    ON [808780e9-fb56-4068-b298-b142ebf3aea8].[comment]([recordGuid] ASC);
