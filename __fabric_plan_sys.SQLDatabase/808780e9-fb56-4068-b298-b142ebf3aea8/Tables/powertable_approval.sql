CREATE TABLE [808780e9-fb56-4068-b298-b142ebf3aea8].[powertable_approval] (
    ...
    CONSTRAINT [FK_4dc3ff09cd30268621a118617d8] FOREIGN KEY ([sourceId]) REFERENCES [808780e9-fb56-4068-b298-b142ebf3aea8].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_recordGuid]
    ON [808780e9-fb56-4068-b298-b142ebf3aea8].[powertable_approval]([recordGuid] ASC);
