CREATE TABLE [808780e9-fb56-4068-b298-b142ebf3aea8].[powertable_forms] (
    ...
    CONSTRAINT [FK_64f3daea4f2056ece36b93069fa] FOREIGN KEY ([sourceId]) REFERENCES [808780e9-fb56-4068-b298-b142ebf3aea8].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_forms_recordGuid]
    ON [808780e9-fb56-4068-b298-b142ebf3aea8].[powertable_forms]([recordGuid] ASC);
