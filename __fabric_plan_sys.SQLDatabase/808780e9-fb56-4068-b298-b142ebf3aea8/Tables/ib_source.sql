CREATE TABLE [808780e9-fb56-4068-b298-b142ebf3aea8].[ib_source] (
    ...
    CONSTRAINT [FK_857e1cee10c832cdd99e84b5e68] FOREIGN KEY ([visualId]) REFERENCES [808780e9-fb56-4068-b298-b142ebf3aea8].[visual] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_source_visualId]
    ON [808780e9-fb56-4068-b298-b142ebf3aea8].[ib_source]([visualId] ASC);


GO

CREATE NONCLUSTERED INDEX [idx_ib_source_workloadItemId]
    ON [808780e9-fb56-4068-b298-b142ebf3aea8].[ib_source]([workloadItemId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_source_recordGuid]
    ON [808780e9-fb56-4068-b298-b142ebf3aea8].[ib_source]([recordGuid] ASC);
