CREATE TABLE [808780e9-fb56-4068-b298-b142ebf3aea8].[powertable_approval_level] (
    ...
    CONSTRAINT [FK_c83f41d1a622e4368ad562c3310] FOREIGN KEY ([approvalId]) REFERENCES [808780e9-fb56-4068-b298-b142ebf3aea8].[powertable_approval] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_level_recordGuid]
    ON [808780e9-fb56-4068-b298-b142ebf3aea8].[powertable_approval_level]([recordGuid] ASC);
