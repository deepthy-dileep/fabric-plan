CREATE TABLE [808780e9-fb56-4068-b298-b142ebf3aea8].[powertable_lookup_config] (
    ...
    CONSTRAINT [FK_44ada73e90ba9eb593ec9ae3d0c] FOREIGN KEY ([sourceId]) REFERENCES [808780e9-fb56-4068-b298-b142ebf3aea8].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_lookup_config_recordGuid]
    ON [808780e9-fb56-4068-b298-b142ebf3aea8].[powertable_lookup_config]([recordGuid] ASC);
