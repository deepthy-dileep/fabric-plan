CREATE TABLE [808780e9-fb56-4068-b298-b142ebf3aea8].[ib_query_writeback_settings] (
    ...
    CONSTRAINT [FK_8bcb8471b229716279935805b96] FOREIGN KEY ([queryId]) REFERENCES [808780e9-fb56-4068-b298-b142ebf3aea8].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_writeback_settings_queryId]
    ON [808780e9-fb56-4068-b298-b142ebf3aea8].[ib_query_writeback_settings]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_writeback_settings_recordGuid]
    ON [808780e9-fb56-4068-b298-b142ebf3aea8].[ib_query_writeback_settings]([recordGuid] ASC);
