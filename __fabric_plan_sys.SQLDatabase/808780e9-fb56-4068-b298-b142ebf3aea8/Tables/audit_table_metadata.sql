CREATE TABLE [808780e9-fb56-4068-b298-b142ebf3aea8].[audit_table_metadata] (
    ...
    CONSTRAINT [FK_92e65ca174f48ee8c2d2276faf1] FOREIGN KEY ([visualId]) REFERENCES [808780e9-fb56-4068-b298-b142ebf3aea8].[visual] ([id])
);
...
CREATE NONCLUSTERED INDEX [idx_audit_table_metadata_visualId_dimensionHash]
    ON [808780e9-fb56-4068-b298-b142ebf3aea8].[audit_table_metadata]([visualId] ASC, [dimensionHash] ASC);
