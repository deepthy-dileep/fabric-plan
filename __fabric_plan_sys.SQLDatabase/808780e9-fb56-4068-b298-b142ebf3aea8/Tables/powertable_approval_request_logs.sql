CREATE TABLE [808780e9-fb56-4068-b298-b142ebf3aea8].[powertable_approval_request_logs] (
    ...
    CONSTRAINT [FK_f93b73db3abf98a99f7f3ed6092] FOREIGN KEY ([approvalRequestId]) REFERENCES [808780e9-fb56-4068-b298-b142ebf3aea8].[powertable_approval_request] ([id])
);
